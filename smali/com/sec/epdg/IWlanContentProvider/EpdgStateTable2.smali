.class Lcom/sec/epdg/IWlanContentProvider/EpdgStateTable2;
.super Ljava/lang/Object;
.source "EpdgStateTable2.java"
...
.field protected static final DATABASE_CREATE:Ljava/lang/String; = "CREATE TABLE IF NOT EXISTS epdgstate2(_id integer primary key autoincrement, epdg_available text not null, epdg_connected text not null, wfc_error text not null, wifi_call_registration text not null, mno_name text not null);"

.field protected static final TABLE_EPDG_STATE2:Ljava/lang/String; = "epdgstate2"
...
.method public static createTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v1, "inside epdg state2 create table"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 34
    const-string v0, "CREATE TABLE IF NOT EXISTS epdgstate2(_id integer primary key autoincrement, epdg_available text not null, epdg_connected text not null, wfc_error text not null, wifi_call_registration text not null, mno_name text not null);"
...
.method private static getEpdgStateRow()Landroid/content/ContentValues;
    ...
    const-string v2, "inside getEpdgStateRow2"
...
.method protected static loadEpdgState(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v2, "inside loadEpdgState2"
    ...
    .line 51
    invoke-static {}, Lcom/sec/epdg/IWlanContentProvider/EpdgStateTable2;->getEpdgStateRow()Landroid/content/ContentValues;
...
.method public static onUpgrade(Landroid/database/sqlite/SQLiteDatabase;I)V
    ...
    const-string v1, "inside epdg state2 table onupgrade: version is: "
    ...
    .line 41
    const-string v0, "DROP TABLE IF EXISTS epdgstate2"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 42
    invoke-static {p0}, Lcom/sec/epdg/IWlanContentProvider/EpdgStateTable2;->createTable(Landroid/database/sqlite/SQLiteDatabase;)V
