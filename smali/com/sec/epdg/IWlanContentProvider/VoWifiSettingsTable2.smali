.class Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;
.super Ljava/lang/Object;
.source "VoWifiSettingsTable2.java"
...
.field private static final DATABASE_CREATE:Ljava/lang/String; = "CREATE TABLE IF NOT EXISTS vowifisetting2(_id integer primary key autoincrement, operatornumeric text not null, wifi_call_enable text not null, wifi_call_preferred text not null, wifi_call_when_roaming text not null, prev_imsi text not null, vowifi_mdn text not null, epdg_support text not null, simmobility_status text not null);"

.field protected static final TABLE_VOWIFISETTINGS2:Ljava/lang/String; = "vowifisetting2"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->newColumns:Ljava/util/ArrayList;
...
.method public static createTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 51
    const-string v0, "CREATE TABLE IF NOT EXISTS vowifisetting2(_id integer primary key autoincrement, operatornumeric text not null, wifi_call_enable text not null, wifi_call_preferred text not null, wifi_call_when_roaming text not null, prev_imsi text not null, vowifi_mdn text not null, epdg_support text not null, simmobility_status text not null);"
...
.method private static getVoWifiSettingsRow(Lorg/xmlpull/v1/XmlPullParser;ZLjava/lang/String;)Landroid/content/ContentValues;
    ...
    invoke-static {}, Lcom/sec/epdg/IWlanContentProvider/IWlanContentProvider;->getMnoName1()Ljava/lang/String;
...
.method private static loadVoWifiSettings(Landroid/database/sqlite/SQLiteDatabase;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)V
    ...
    .line 146
    :cond_0
    invoke-static {p1}, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->nextElement(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 153
    invoke-static {p1, v3, p2}, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->getVoWifiSettingsRow(Lorg/xmlpull/v1/XmlPullParser;ZLjava/lang/String;)Landroid/content/ContentValues;
    ...
    .line 155
    invoke-static {p0, p2}, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->isEntryExistForOperator(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
...
.method public static onUpgrade(Landroid/database/sqlite/SQLiteDatabase;I)V
    ...
    .line 57
    invoke-static {p0}, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->createTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {p0, v0, v1}, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->findExistColumnInTable(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 60
    const-string v0, "ALTER TABLE vowifisetting2 ADD COLUMN epdg_support Integer DEFAULT 0"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 61
    const-string v0, "ALTER TABLE vowifisetting2 ADD COLUMN simmobility_status Integer DEFAULT 0"
...
.method public static resetDatabase(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    .line 237
    invoke-static {p0, v2, p1}, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->loadVoWifiSettings(Landroid/database/sqlite/SQLiteDatabase;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)V
    :try_end_0
...
.method protected static upgradeVoWifiSettings(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)V
    ...
    sget-object v5, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->newColumns:Ljava/util/ArrayList;
    ...
    :try_start_1
    const-string v9, "vowifisetting2"
    ...
    :try_start_6
    invoke-static {v9, v0, v11}, Lcom/sec/epdg/IWlanContentProvider/VoWifiSettingsTable2;->loadVoWifiSettings(Landroid/database/sqlite/SQLiteDatabase;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)V
    :try_end_6
